  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center justify-center">
        <h1 className="text-2xl font-bold text-gray-900 text-center">Filter Orders</h1>
...
<PaymentStatusModal isOpen={showConfirmationModal} message={loadingMessage} />
...
// // Updated table body to handle MongoDB data structure
// <tbody className="divide-y divide-gray-200">
